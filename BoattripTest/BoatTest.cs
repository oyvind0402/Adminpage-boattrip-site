...
namespace BoattripTest
{
    public class BoatTest
    {
        ...
        [Fact]
        public async Task GetAllBoatsLoggedInOK()
        {
        ...
        [Fact]
        public async Task GetOneBoatLoggedIn()
        {
            //arrange
            var boat1 = new Boat { BoatName = "Colorline", Capacity = 1000, TicketPrice = 400 };
        ...
        [Fact]
        public async Task GetOneBoatLoggedInNotOK()
        {
        ...
        [Fact]
        public async Task GetOneBoatNotLoggedIn()
        {
            //arrange
        ...
        [Fact]
        public async Task SaveBoatLoggedInOK()
        {
        ...
        [Fact]
        public async Task SaveBoatLoggedInNotOK()
        {
        ...
        public async Task SaveBoatLoggedInFailModel()
        {
        ...
        [Fact]
        public async Task SaveBoatNotLoggedIn()
        {
            mockRep.Setup(k => k.SaveBoat(It.IsAny<Boat>())).ReturnsAsync(true);
        ...
        [Fact]
        public async Task DeleteBoatLoggedInOK()
        {
        ...
        [Fact]
        public async Task DeleteBoatNotLoggedIn()
        {
            // Arrange
        ...
        [Fact]
        public async Task DeleteBoatLoggedInNotOK()
        {
            // Arrange
